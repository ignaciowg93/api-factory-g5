...
s51.seller.create(seller: '3', time: 1.846)
s51.seller.create(seller: '2', time: 2.368)
s51.seller.create(seller: '1', time: 2.046)
s52 = p5.supplies.create(sku: '6', requierment: 228, stock_reservado: 0)
s52.seller.create(seller: '8', time: 2.481)
s52.seller.create(seller: '6', time: 2.916)
s52.seller.create(seller: '2', time: 2.123)
s53 = p5.supplies.create(sku: '41', requierment: 194, stock_reservado: 0)
s53.seller.create(seller: '7', time: 2.091)
s53.seller.create(seller: '3', time: 1.460)
s53.seller.create(seller: '2', time: 1.687)

s11 = p11.supplies.create(sku: '4', requierment: 828, stock_reservado: 0)
s11.seller.create(seller: '8', time: 1.205)
s11.seller.create(seller: '6', time: 2.615)
s11.seller.create(seller: '4', time: 2.713)

s171 = p17.supplies.create(sku: '25', requierment: 360, stock_reservado: 0)
s171.seller.create(seller: '7', time: 0.945)
s171.seller.create(seller: '5', time: 2.785)
s171.seller.create(seller: '3', time: 3.254)
s171.seller.create(seller: '1', time: 0.821)
s172 = p17.supplies.create(sku: '20', requierment: 350, stock_reservado: 0)
s172.seller.create(seller: '8', time: 2.258)
s172.seller.create(seller: '6', time: 3.356)
s172.seller.create(seller: '4', time: 1.955)
s172.seller.create(seller: '2', time: 3.475)
s173 = p17.supplies.create(sku: '13', requierment: 290, stock_reservado: 0)
s173.seller.create(seller: '7', time: 1.304)
s173.seller.create(seller: '3', time: 3.164)
s173.seller.create(seller: '1', time: 3.256)

s22 = p22.supplies.create(sku: '6', requierment: 380, stock_reservado: 0)
s22.seller.create(seller: '8', time: 2.481)
s22.seller.create(seller: '6', time: 2.916)
s22.seller.create(seller: '2', time: 2.123)

s521 = p52.supplies.create(sku: '8', requierment: 1000, stock_reservado: 0)
s521.seller.create(seller: '6', time: 3.773)
s521.seller.create(seller: '4', time: 2.531)
s521.seller.create(seller: '2', time: 1.516)
s522 = p52.supplies.create(sku: '38', requierment: 20, stock_reservado: 0)
s521.seller.create(seller: '8', time: 3.462)
s521.seller.create(seller: '7', time: 3.128)

s561 = p56.supplies.create(sku: '1', requierment: 935, stock_reservado: 0)
s561.seller.create(seller: '3', time: 3.605)
s561.seller.create(seller: '1', time: 2.176)
s562 = p56.supplies.create(sku: '26', requierment: 65, stock_reservado: 0)
s562.seller.create(seller: '8', time: 3.059)
s562.seller.create(seller: '6', time: 1.092)
s562.seller.create(seller: '4', time: 1.242)
s562.seller.create(seller: '2', time: 2.609)
